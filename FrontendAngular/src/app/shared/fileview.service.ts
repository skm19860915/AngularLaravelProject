...
export class FileviewService {
  ...
  editFolderPrivacy(requestPayload: object): Observable<any> {
    return this.http.post(AppSettings.backendURL+'api/fileview/editFolderPrivacy', requestPayload);
  }
  ...
  getFileByCategoryByPath(requestPayload: object): Observable<any> {
    return this.http.post(AppSettings.backendURL+'api/fileview/getFileByCategoryByPath', requestPayload);
  }
}
