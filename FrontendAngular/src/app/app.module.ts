...
import { ContentComponent } from './components/firstpage/content/content.component';
...
import { MoveConfirmModalComponent } from './tools/modals/move-confirm-modal/move-confirm-modal.component';
...
@NgModule({
  declarations: [
    ...
    FaqComponent,
    PageComponent,
    MoveConfirmModalComponent,
    AlbumShareModalComponent,
    AlbumComponent,
  ],
  imports: [
    ReactiveFormsModule,
